...
class CategorieIndex(QWidget):
    ...
    def setup_ui(self):
        ...
        if not self._is_admin():
            self.new_category_btn.setVisible(False)
    ...
    def create_new_category(self):
        if not self._is_admin():
            QMessageBox.warning(self, "Accès refusé", "Seuls les administrateurs peuvent créer des catégories.")
            return
    ...
    def edit_category(self, category):
        if not self._is_admin():
            QMessageBox.warning(self, "Accès refusé", "Seuls les administrateurs peuvent modifier des catégories.")
            return
    ...
    def toggle_category_status(self, category):
        if not self._is_admin():
            QMessageBox.warning(self, "Accès refusé", "Seuls les administrateurs peuvent activer/désactiver des catégories.")
            return
