...
class BoutiqueWindow(QMainWindow):
    ...
    def setup_tabs(self):
        ...
        try:
            ...
            # Onglet Catégories - Visible pour tous (restrictions dans le widget)
            ...
            # Onglet Produits - Visible pour tous (restrictions dans le widget)
            ...
            # Onglet Services - Gestion des services (admin uniquement)
            if self._is_admin():
                pos_id = getattr(self.boutique_controller, 'pos_id', 1)
