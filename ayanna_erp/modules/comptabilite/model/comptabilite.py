...
class ComptaConfig(Base):
    ...
    compte_fournisseur_id = Column(Integer, ForeignKey('compta_comptes.id'), nullable=True)  # Compte fournisseur créditeur (401)
    compte_fournisseur_debiteur_id = Column(Integer, ForeignKey('compta_comptes.id'), nullable=True)  # Compte fournisseur débiteur avances (409)
    ...
    compte_fournisseur_debiteur = relationship("ComptaComptes", foreign_keys=[compte_fournisseur_debiteur_id])
