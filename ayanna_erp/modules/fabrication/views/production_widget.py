...
class ProductionWidget(QWidget):
    ...
    def create_production(self):
        QMessageBox.information(self, "TODO", "Création production — implémentation future (sélection règle, quantité, entrepôt)")

    def open_production(self, production_id: int):
        QMessageBox.information(self, "TODO", f"Ouvrir fiche production {production_id} — implémentation future")
