...
class UserIndexView(QWidget):
    ...
    def create_filter_layout(self):
        ...
        self.search_edit.setPlaceholderText("Nom, email...")
    ...
    def create_stats_layout(self):
        ...
        self.caissiers_label = QLabel("Caissiers: 0")
        
        # Style des labels de statistiques
        for label in [self.total_users_label, self.admins_label, self.caissiers_label]:
            label.setStyleSheet("""
                QLabel {
                    font-weight: bold;
                    color: #2c3e50;
        ...
        stats_layout.addWidget(self.caissiers_label)
    ...
    def update_stats(self):
        ...
        caissiers = len([u for u in self.users_data if u.get('role') == 'caissier'])
        
        self.total_users_label.setText(f"Total: {total}")
        self.admins_label.setText(f"Admins: {admins}")
        self.caissiers_label.setText(f"Caissiers: {caissiers}")
