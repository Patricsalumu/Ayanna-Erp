...
class LoginWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle(f"{Config.APP_NAME} {Config.APP_VERSION} - Connexion")
    ...
    def setup_header(self, layout):
        ...
        title_label = QLabel(f"AYANNA ERP {Config.APP_VERSION}")
    ...
    def setup_footer(self, layout):
        ...
        # Texte de base
        base_text = "© 2026 Ayanna ERP - Tous droits réservés"
