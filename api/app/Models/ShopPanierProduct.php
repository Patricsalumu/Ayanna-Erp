...
class ShopPanierProduct extends Model
{
    use HasUuids, SoftDeletes;
    protected $table = 'shop_panier_products';
    protected $fillable = ['id', 'panier_id', 'product_id', 'quantite', 'prix_unitaire', 'remise', 'total'];
